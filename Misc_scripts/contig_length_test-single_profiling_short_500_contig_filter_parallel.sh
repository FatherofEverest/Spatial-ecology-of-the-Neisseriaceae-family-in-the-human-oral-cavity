...
DIR_SinglePROF=$DIR_CLE/06_PROFILES/Concatenated_both_short_500_filter
...
do
        ...
        /workspace/jmarkwelchlab/P_0003_Neisseriaceae/SCRIPTS/contig_length_test_script-single_profile_short_500_filter.sh $metagenome &
        fi
done
...
ELAPSED="Profiling - short 500 nt filter $(($SECONDS / 3600))hrs $((($SECONDS / 60) % 60))min $(($SECONDS % 60))sec"
