...
DIR_SinglePROF=$DIR_CLE/06_PROFILES/Concatenated_both_short_filter
...
do
        ...
        /workspace/jmarkwelchlab/P_0003_Neisseriaceae/SCRIPTS/contig_length_test_script-single_profile_short_filter.sh $metagenome &
        fi
done
