...
WORK_DIR=$mainDIR
# internal GENOMES.db
projectGenomesDB=$DIR_Pangenome/${projectID}-GENOMES.db
# internal PAN.db
projectPanDIR=$DIR_Pangenome/${projectID}-RESULTS
# profile collection
COLLECTION=Genomes
# contigsDB with path
...
echo "$ELAPSED" >> ${mainDIR}/TIMES/time-12-metapangenome_per_site.tsv
